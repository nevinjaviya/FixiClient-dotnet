...
namespace Decos.Fixi
{
  ...
  public interface ICannedResponsesApi
  {
    ...
    /// </returns>
    [Get("/organization/{id}/cannedresponses")]
    ...
    [Get("/organization/{id}/cannedresponses/{name}")]
    ...
    [Post("/organization/{id}/cannedresponses")]
    ...
    [Patch("/organization/{id}/cannedresponses/{name}")]
